<div class="col-md-3">
	...
	<?php foreach ($retproject as $project):?>
		<div class="onhoverproject" id="project<?=$project['id']?>"><a class="projectlinks <?=$project['select']?>" href="http://<?=$site?>/project/<?=$project['id']?>">
			...
			<div class="showproject dropdown">
			<div>
    ...
    <div style="display:none;" id="newproject">
      <div class="input-group">
        <input name="color" type="color" style="height:38px;width: 50px !important;" class="form-control">
        <input name="name" placeholder="Project name" type="text" class="form-control" style="width: 100% !important;">
      </div>
